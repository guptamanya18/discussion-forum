"""
Shared fixtures for comment_service async tests.
...
import app.routes.comment_routes as routes_mod
import app.main as main_mod

routes_mod.kafka_producer = _mock_kafka
main_mod.kafka_producer = _mock_kafka

# Mock httpx so create_comment doesn't try to reach thread_service
routes_mod.THREAD_SERVICE_URL = "http://127.0.0.1:1"  # fast-fail, wrapped in try/except
